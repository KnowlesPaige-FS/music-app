...
app.get('/client-credentials', (req, res) => {
    ...
    .catch(err => {
        // console.error('Error retrieving an access token using client credentials:', err.message);
...
app.post('/login', (req, res) => {
    ...
    .catch(err => {
        // console.error('Error retrieving an access token using authorization code grant:', err.message);
